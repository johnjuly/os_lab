    ...
    switch (tf->cause) {
        ...
        case CAUSE_BREAKPOINT:
            ...
            */
            ...
            tf->epc += 2;  // 跳过断点指令（ebreak is 2 bytes in compressed ISA）
            cprintf("epc after increment: 0x%08x, will return to 0x%08x\n", tf->epc, tf->epc);
            break;
